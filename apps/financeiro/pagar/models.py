...
class GastoBase(models.Model):
    ...
    data_vencimento = models.DateField(verbose_name="Data de Vencimento / Pagamento")
...
class ComissaoArquiteto(models.Model):
    ...
    banco_origem = models.ForeignKey('receber.Banco', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Conta de Saída")
    movimento_banco = models.OneToOneField('receber.MovimentoBanco', on_delete=models.SET_NULL, null=True, blank=True, related_name='comissao_arquiteto_origem')
    movimento_caixa = models.OneToOneField('receber.CaixaDiario', on_delete=models.SET_NULL, null=True, blank=True, related_name='comissao_arquiteto_origem')

    class Meta:
        verbose_name = "Comissão de Arquiteto"
        verbose_name_plural = "Comissões de Arquitetos"

    def get_valor_consolidado(self): return self.valor_comissao
    def get_model_name(self): return self.__class__.__name__
    def get_tipo_classe(self): return self.__class__.__name__
...
class GastoGasolina(models.Model):
    ...
    banco_origem = models.ForeignKey('receber.Banco', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Conta de Saída")
    movimento_banco = models.OneToOneField('receber.MovimentoBanco', on_delete=models.SET_NULL, null=True, blank=True, related_name='gasto_gasolina_origem')
    movimento_caixa = models.OneToOneField('receber.CaixaDiario', on_delete=models.SET_NULL, null=True, blank=True, related_name='gasto_gasolina_origem')
...
class FolhaPagamento(models.Model):
    ...
    banco_origem = models.ForeignKey('receber.Banco', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Conta de Saída")
    movimento_banco = models.OneToOneField('receber.MovimentoBanco', on_delete=models.SET_NULL, null=True, blank=True, related_name='folha_pagamento_origem')
    movimento_caixa = models.OneToOneField('receber.CaixaDiario', on_delete=models.SET_NULL, null=True, blank=True, related_name='folha_pagamento_origem')
